        ...
        <>
            <article className="font-bold text-center">
                ...
                <section className={showOptions ? "visible flex flex-col justify-center items-center" : "invisible"}>
                    ...
                    <SelectComponent list={colors} defaultOption={"Color de la hora"} defaultValue={"white"} onSelect={handleChangeColor} />

                    <SelectComponent list={size} defaultOption={"Tamaño de la hora"} defaultValue={"text-md"} onSelect={handleChangeSize} />
